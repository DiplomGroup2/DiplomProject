...
<div class="container-center-horizontal">
        <div class="desktop-11 screen">
            <div class="overlap-group7">
                ...
                <img class="line-1"
                     :src="require('@/assets/Line 1.jpg')" />
                <img class="line-2"
                     :src="require('@/assets/Line 2.jpg')" />
                <img class="group-18"
                     src="https://anima-uploads.s3.amazonaws.com/projects/62d2d7d3f9ede3e68a5f3c76/releases/62d2d824588fd82329642652/img/group-18-3@2x.svg" />
                ...
                <div class="overlap-group1">
                    ...
                    <div class="fix fredoka-light-black-16px">Private</div>
                    <div class="group-container">
                        <div class="group-67">
                            <img :src="require('@/assets/Group 70.jpg')"/>
                        </div>
                    </div>
                </div>
                <div class="trash fredoka-light-black-16px" onclick="">
                    <img :src="require('@/assets/Mask group.jpg')"/>trash
                </div>
                ...
                <div class="overlap-group4">
                    ...
                    <div class="overlap-group-1">
                             ...
                             <img :src="require('@/assets/Group 66.jpg')"/>
                        
                    </div>
                </div>
                <div class="overlap-group5">
                    <img class="group-71"
                         src="https://anima-uploads.s3.amazonaws.com/projects/62d2d7d3f9ede3e68a5f3c76/releases/62d2d824588fd82329642652/img/group-71@2x.svg" />
                    <div class="ellipse-7 border-0-5px-white"></div>
                </div>
                <div class="overlap-group6">
                    <img :src="require('@/assets/Group 68.jpg')"/>
             ...
             <div class="rectangle-126">
               ...
               <img
                 class="line-9"
                 src="https://anima-uploads.s3.amazonaws.com/projects/62e6784a8189d94556206231/releases/62e678721dfd2bd9a2e6597d/img/line-9@2x.svg"
                />
              </div>
            </div>
            
          </div>
            <img class="mask-group-1"
                 src="https://anima-uploads.s3.amazonaws.com/projects/62d2d7d3f9ede3e68a5f3c76/releases/62d2d824588fd82329642652/img/mask-group-19@2x.svg" />
            <div class="group-10">
          <div class="overlap-group-2">
            <div class="rectangle-9" >
                <img :src="require('@/assets/Group 11.jpg')"/>
            </div>
          </div>
          <div class="group-12 border-0-3px-fresh-air">
            <img :src="require('@/assets/Group 12.jpg')"/>
          </div>
          <div class="group-13 border-0-3px-fresh-air">
            <img :src="require('@/assets/Group 13.jpg')"/>
          </div>
          <div class="group-13 border-0-3px-fresh-air" onclick="" >
            <img :src="require('@/assets/Group 14.jpg')"/>
          </div>
        </div>
        </div>       
    </div>
...
<style scoped>
    ...
    .desktop-11 .overlap-group7 {
        ...
        .desktop-11 .rectangle-24 {
            -webkit-backdrop-filter: blur(15px) brightness(100%);
            background-image: url("@/assets/Rectangle 24.jpg");
    ...
    */
        ...
        .desktop-11 .ellipse-43 {
  border: 1px solid #0083b3;
  border-radius: 5.73px/5.59px;
  height: 11px;
  left: 0;
  position: absolute;
  top: 0;
...
.desktop-11 .line-9 {
  ...
  width: 6px;
        ...
        .desktop-11 .rectangle-126 {

           background-color: var(--gray);
  border: 0.4px solid #83b3de;
  border-radius: 13px;
  height: 31px;
  left: 991px;
  position: absolute;
  ...
  width: 21px;
        ...
        .desktop-11 .group-14 {
            ...
            background-image: url("@/assets/Group 14.jpg");
    ...
    * {
    ...
    .border-0-4px-glacier {
       border: 0.4px solid var(--glacier);
    }
